...
class WaterDropNavBar extends StatefulWidget {
  ...
  /// Size of water drop, defaults to screen width / bar item count.
  final double? waterDropWidth;

  /// Size of water drop, defaults to screen height / bar item count.
  final double? waterDropHeight;
  ...
  /// Label for given Item, can be null.
  final List<String>? label;

  /// Callback for floating mid button, can be null.
...
class _WaterDropNavBarState extends State<WaterDropNavBar>
  ...
  Widget build(BuildContext context) {
    ...
    final List<String>? label = widget.label;
    ...
    final double? waterDropWidth = widget.waterDropWidth;
    final double? waterDropHeight = widget.waterDropHeight;
      ...
      child: Stack(
        children: <Widget>[
          ...
          BuildRunningDrop(
            ...
            color: dropColor,
            waterDropWidth: waterDropWidth,
            waterDropHeight: waterDropHeight,
          ),
          Align(
            alignment: Alignment.bottomCenter,
            child: InkWell(
